...
export const ROLE_DESCRIPTIONS = {
  BACKEND: "Focus on API design, database integrity, and efficient processing of scan results.",
  DEVOPS: "Focus on CI/CD pipeline integration, Docker containerization, and automated workflows.",
  SECURITY: "Focus on vulnerability identification, OWASP standards, and remediation strategies.",
  FULLSTACK: "Integrating the React frontend with the analysis engine and database."
};
