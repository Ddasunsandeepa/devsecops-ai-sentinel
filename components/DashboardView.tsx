    ...
    <div className="space-y-6 animate-fade-in pb-10">
      <div>
        ...
        <p className="text-slate-400">
          Real-time metrics from the DevSecOps pipeline.
        </p>
      </div>
        ...
        <div className="lg:col-span-1 bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-lg">
          ...
          <div className="space-y-4">
            {[1, 2, 3, 4, 5].map((i) => (
              <div
                key={i}
                className="flex gap-3 items-start border-b border-slate-800 pb-3 last:border-0 last:pb-0"
              >
                <div className="mt-1">
                  {i === 1 ? (
                ...
                <div>
                  <p className="text-sm text-slate-200">
                    {i === 1
                      ? "Critical SQLi found in auth-service"
                      : i === 2
                        ? "Scan passed for user-service"
                        : "New push to inventory-api"}
                  </p>
